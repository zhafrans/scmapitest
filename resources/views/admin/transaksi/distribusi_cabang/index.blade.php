...
@section('title')
    Transaksi Distribusi Ke Cabang
@endsection
...
@section('content')
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Transaksi Distribusi Ke Cabang</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="{{ route('index') }}">Home</a>&nbsp;<i
                        class="fa fa-angle-right"></i>
                </li>                
                <li class="active"><a href="{{ route('admin.transaksi.distribusi_cabang') }}">Transaksi Distribusi Ke Cabang</a></li>
            </ol>
        </div>        
    </div>
                ...
                <div class="card-body ">
                    <div class="row p-b-20">
                        <div class="col-md-6 col-sm-6 col-6">
                            <div class="btn-group">                                
                                <a href="{{ route('admin.transaksi.distribusi_cabang.create') }}" class="btn btn-info">
